  ...
  <div className="modal-box dark:bg-black dark:outline-1 dark:text-white">
    ...
    <h3 className="font-bold text-lg">Signup</h3>
      <div className="name my-3">
          <InputText type="text" placeholder="Enter your fullname." name="name" onChange={(e)=> setName(e.target.value)} value={name} required />
      </div>
      ...
      <div className="password my-3 flex justify-around align-middle">
          ...
          <p className="">Aready register? <button className='text-blue-900 underline underline-offset-4 cursor-pointer' onClick={()=> {const signup = document.getElementById('signup_modal');
